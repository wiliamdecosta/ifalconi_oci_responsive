...
class P_bank_branch_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_bank_branch_id');
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('pay_param/p_bank_branch');
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(bank_branch.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') OR UPPER(bank.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_bank_branchcontroller.php */
/* Location: ./application/libraries/P_bank_branchcontroller.php */
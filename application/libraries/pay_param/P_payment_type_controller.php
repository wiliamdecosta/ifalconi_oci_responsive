...
/**
* Json library
* @class P_payment_type_controller
...
class P_payment_type_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_payment_type_id');
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('pay_param/p_payment_type');
		    $table = $ci->p_payment_type;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(payment_type.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_payment_type_controller.php */
/* Location: ./application/libraries/P_payment_type_controller.php */
...
class P_stamp_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_stamp_id');
    	$dir  = getVarClean('dir','str','DESC');
    	
        $searchPhrase = getVarClean('searchPhrase', 'str', '');
        $p_stamp_id = getVarClean('p_stamp_id', 'int', 0);
    	...
    	try {
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(stamp.description) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_stampcontroller.php */
/* Location: ./application/libraries/P_stampcontroller.php */
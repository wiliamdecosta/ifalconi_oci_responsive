...
class P_bank_controller {
    ...
    function read() {
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('pay_param/p_bank');
		    $table = $ci->p_bank;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(bank.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* Location: ./application/libraries/P_bank_controller.php */
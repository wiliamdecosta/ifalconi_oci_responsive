...
/**
* Json library
* @class P_payment_penalty_controller
...
class P_payment_penalty_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_payment_penalty_id');
    	$dir  = getVarClean('dir','str','DESC');
    	
        $searchPhrase = getVarClean('searchPhrase', 'str', '');
        $p_payment_penalty_id = getVarClean('p_payment_penalty_id', 'int', 0);
        $p_penalty_group_id = getVarClean('p_penalty_group_id', 'int', 0);
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('pay_param/p_payment_penalty');
		    $table = $ci->p_payment_penalty;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(payment_penalty.description) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_payment_penalty_controller.php */
/* Location: ./application/libraries/P_payment_penalty_controller.php */
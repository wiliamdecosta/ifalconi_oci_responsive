...
/**
* Json library
* @class P_penalty_group
* @version 07/05/2015 12:18:00
*/
class P_penalty_group_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_penalty_group_id');
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('pay_param/p_penalty_group');
		    $table = $ci->p_penalty_group;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(penalty_group.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_penalty_group_controller.php */
/* Location: ./application/libraries/P_penalty_group_controller.php */
...
class P_application_role_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_application_role_id');
    	$dir  = getVarClean('dir','str','ASC');
    	
        $searchPhrase = getVarClean('searchPhrase', 'str', '');
        $p_application_role_id = getVarClean('p_application_role_id', 'int', 0);
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('adm_sistem/p_application_role');
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(application.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* Location: ./application/libraries/P_application_role_controller.php */
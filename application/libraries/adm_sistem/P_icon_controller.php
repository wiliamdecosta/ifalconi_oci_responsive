...
class P_icon_controller {
    ...
    function read() {
        ...
        $p_icon_id = getVarClean('p_icon_id', 'int', 0);
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('adm_sistem/p_icon');
		    $table = $ci->p_icon;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(icon.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_icon_controller.php */
/* Location: ./application/libraries/P_icon_controller.php */
...
class P_user_role_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_user_role_id');
    	$dir  = getVarClean('dir','str','DESC');
    	
        $searchPhrase = getVarClean('searchPhrase', 'str', '');
        $p_user_role_id = getVarClean('p_user_role_id', 'int', 0);
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('adm_sistem/p_user_role');
		    $table = $ci->p_user_role;
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(role.code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_user_role_controller.php */
/* Location: ./application/libraries/P_user_role_controller.php */
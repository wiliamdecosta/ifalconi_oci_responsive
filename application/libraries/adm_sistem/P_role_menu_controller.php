...
class P_role_menu_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort','str','p_role_menu_id');
    	$dir  = getVarClean('dir','str','ASC');
    	
        $searchPhrase = getVarClean('searchPhrase', 'str', '');
        $p_role_menu_id = getVarClean('p_role_menu_id', 'int', 0);
    	...
    	try {
		    ...
		    if(!empty($p_application_id)) {
		        $table->setCriteria("(role_menu.p_application_id = ".$p_application_id.")");        
		    }
		    
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("( UPPER(role_menu.menu_code) ".$table->likeOperator." UPPER('%".$searchPhrase."%') )"); 
		    }
...
/* End of file P_role_menu_controller.php */
/* Location: ./application/libraries/P_role_menu_controller.php */
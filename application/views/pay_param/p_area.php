                ...
                <thead>
                  <tr>
                    <th data-identifier="true" data-visible="false" data-header-align="center" data-align="center" data-column-id="p_area_id"> ID Area</th>
                     ...
                     <th data-column-id="code" data-width="190">Area Code</th>
        ...
        $("#area_grid_selection").bootgrid({
    	     formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="#" title="Edit" onclick="area_show_form_edit(\''+ row.p_area_id +'\')" class="green"><i class="ace-icon fa fa-pencil bigger-130"></i></a> &nbsp; <a href="#" title="Delete" onclick="area_delete_records(\''+ row.p_area_id +'\')" class="red"><i class="ace-icon glyphicon glyphicon-trash bigger-130"></i></a>';
                }
             },
    ...
    function area_delete_records(theID) {
        BootstrapDialog.confirm({
		    ...
		    callback: function(result) {
    	        if(result) {
    	            $.post( "<?php echo WS_URL.'pay_param.p_area_controller/destroy'; ?>",

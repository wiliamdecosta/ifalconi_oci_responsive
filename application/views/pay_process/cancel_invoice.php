<?php
    ...
    check_payment_login("pay_process-cancel_invoice.php");
?>
            	 ...
            	 <div class="panel panel-info">
            	      ...
            	      <div class="panel-body">
                          ...
                          <div class="col-xs-12">
                    		  ...
                    		  <button id="btnPembatalan" class="btn btn-primary btn-sm">Cancel Invoice</button>
                		  </div>
...
jQuery(function($) {
      ...
      $("#btnPembatalan").on(ace.click_event, function () {
          ...
          BootstrapDialog.show({
                ...
                message: 'Your Total Cancel Invoice : <b> Rp. ' + $.number($("#form_summary_grand_total").val(), 2, '.', ',') + '</b>. Are You sure to make a cancel payment?',
                buttons: [{
...
function create_stp_pay_acc_table(show_progressbar, is_after_payment) {
	...
	$("#grid-selection").bootgrid({
	     ...
	     url: "<?php echo PAYMENT_WS_URL.'ws.php?type=json&module=paymentccbs&class=payment&method=cancel_payment'; ?>",
	     searchSettings:{
	        delay:100,
	        characters: 3
	     },
...
function execute_cancel_invoice() {

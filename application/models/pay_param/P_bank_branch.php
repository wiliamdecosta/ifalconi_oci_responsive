...
class P_bank_branch extends Abstract_model {
	...
	public $fromClause 		= "p_bank_branch bank_branch
                                    LEFT JOIN p_bank bank ON bank_branch.p_bank_id = bank.p_bank_id
                                    LEFT JOIN p_area bank_area ON bank_branch.p_area_id = bank_area.p_area_id";

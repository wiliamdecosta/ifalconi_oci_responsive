...
class P_area extends Abstract_model {
	...
	public $selectClause 	= "area.p_area_id, area.code, area.description, to_char(area.create_date, 'yyyy-mm-dd') as create_date, 
                                    to_char(area.update_date, 'yyyy-mm-dd') as update_date, area.create_by, area.update_by";
	public $fromClause 		= "p_area area";

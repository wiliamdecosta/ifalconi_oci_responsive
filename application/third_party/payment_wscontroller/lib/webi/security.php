...
class wbSecurity extends Object{
    ...
    public static function check($name, $action = 1, $module = ""){
        ...
        throw new Exception("Anda tidak memiliki hak akses untuk melakukan operasi ini<br/><br/>Nama Akses : ".self::$accessList[$action]." on ".$module.'.'.$name."<br/>Silahkan hubungi Administrator untuk mendapatkan akses tersebut");
    }
